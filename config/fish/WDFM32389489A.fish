...
set -x no_proxy cloud.sap,sap.corp,localhost,127.0.0.1,192.168.1.100,192.168.40.17,192.168.40.18,192.168.40.19,10.44.10.16,10.44.10.17,10.44.10.18,10.44.9.1,147.204.8.60,10.44.11.1
